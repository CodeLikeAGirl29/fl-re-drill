...
import { getUniqueCategories } from "@/app/lib/utils";
...
export default function WelcomeScreen({
  ...
  return (
    <div className="mx-auto w-full max-w-2xl rounded-2xl border border-white/10 bg-slate-900/60 backdrop-blur-xl shadow-2xl text-white overflow-hidden">
      {/* 1. THE IMAGE HEADER */}
      <div className="relative w-full aspect-video mb-8 overflow-hidden border-b border-white/10">
        {mounted && (
          <Image
        ...
        <div className="absolute bottom-6 left-6 max-w-[80%]">
          <div className="bg-slate-900/95 backdrop-blur-md text-white px-5 py-3 rounded-xl shadow-2xl border border-white/10">
            <h1 className="text-xl md:text-2xl font-black tracking-tight uppercase italic">
              Florida Real Estate <span className="text-cyan-400">Drill</span>
            </h1>
      ...
      <div className="p-6 md:p-8">
        <div className="mb-8">
          <p className="text-cyan-400 text-md italic font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/[0.08] transition-colors">
            <IoFlash className="text-amber-400 mt-1 shrink-0" size={20} />
            <div>
          ...
          <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/[0.08] transition-colors">
            <IoBook className="text-cyan-400 mt-1 shrink-0" size={20} />
            <div>
        ...
        <div className="mb-6">
          <label
            ...
            className="flex items-center gap-2 text-slate-400 text-xs uppercase tracking-widest font-bold mb-3"
          >
            <IoFilter size={14} className="text-cyan-400" /> Select Focus Area
          </label>
          <div className="relative">
            <select
              ...
              className="w-full p-4 bg-white/5 border border-white/10 rounded-xl text-white appearance-none focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-all cursor-pointer pr-10"
            >
              {categories.map((cat) => (
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <motion.button
              ...
              className="flex-1 group h-14 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-black uppercase tracking-wider rounded-xl transition-all duration-300 hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] active:scale-95 flex items-center justify-center gap-2"
            >
            ...
            <motion.button
              ...
              className="flex-1 group inline-flex items-center justify-center h-14 rounded-xl border border-cyan-500/40 bg-cyan-500/10 px-6 font-black uppercase tracking-wider text-cyan-300 transition-all hover:bg-cyan-500/20 hover:text-white active:scale-95"
            >
              <span className="flex items-center gap-2">
                <IoFlash className="text-amber-400" />
                Quick 20
              </span>
            </motion.button>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 text-center">
          <p className="text-[0.625rem] text-slate-400 uppercase tracking-[0.2em]">
            State Exam Goal:{" "}
            <span className="text-cyan-400 font-bold">75% Passing Score</span>
          </p>
        </div>
      </div>
    </div>
